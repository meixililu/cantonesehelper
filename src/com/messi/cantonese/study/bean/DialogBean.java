...
public class DialogBean implements BaseBean{
	...
	public void setQuestion_lan(String question_lan) {
		this.question_lan = question_lan;
	}
	...
	public void setResult_lan(String result_lan) {
		this.result_lan = result_lan;
	}
	...
	public String toString() {
		return "DialogBean [id=" + id + ", question=" + question + ", answer="
				...
				+ speak_speed + ", question_lan=" + question_lan
				+ ", result_lan=" + result_lan + "]";
	}
