...
public class DataBaseUtil {
	...
	public long insert(DialogBean bean) {
		...
		values.put(LHContract.FeedEntry.COLUMN_NAME_QUESTION_LAN, bean.getQuestion_lan());
		values.put(LHContract.FeedEntry.COLUMN_NAME_RESULT_LAN, bean.getResult_lan());
	...
	private void getOneBean(Cursor cursor,List<DialogBean> noteBeans){
		while (cursor.moveToNext()) {
			...
			String question_lan = cursor.getString(cursor.getColumnIndex("question_lan"));
			String result_lan = cursor.getString(cursor.getColumnIndex("result_lan"));
			...
			mBean.setQuestion_lan(question_lan);
			mBean.setResult_lan(result_lan);
